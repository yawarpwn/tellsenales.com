...
export default function WhatsappBtnPopup() {
	...
	return (
		<>
          ...
          ${isOpen ? 'invisible translate-y-10 opacity-0 ' : 'visible translate-y-0 opacity-100'}
          ...
          items-center justify-center rounded-full bg-green-500 text-white outline-none transition-all duration-300 ease-in-out`}
				>
					{!isOpen ? (
						<svg
							baseProfile="tiny"
            ...
            ${!isOpen ? 'invisible translate-x-12 opacity-0' : 'visible translate-x-0 opacity-100'}
          ...
          `}
				>
					<div className="WhatsappBtnPopup-Wrapper rounded-lg p-4 shadow-lg">
						<div className="text-center text-xs ">El equipo suele responder en unos minutos</div>
						<div className=" mt-[14px] bg-slate-50/5">
							...
							>
								<div className="w-[50px]">
									<img src="/assets/team/raquel_maldonado.webp" alt="Raquel Maldonado Ramirez" />
								</div>
								<div className="min-h-12 table-cell h-12 align-middle">
									<div className="text-sm">Raquel Maldonado Ramirez</div>
